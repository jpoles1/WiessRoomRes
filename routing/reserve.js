module.exports = function(app, Reservation){
  ...
  app.post("/createRes", function(req, res){
    ...
    var newres = new Reservation({ reserver: req.body.reserver, email: req.body.email, why: req.body.why, room: req.body.roomName, eventName: req.body.eventName, start: req.body.startTime, end: req.body.endTime, "rejected": [], "added": []});
